...
var Menu = {
    ...
    SyncCardList: function () {
        $.getJSON(CONFIG.BASEURL + "/media/sync", {}, function (data) {
            Menu.GetCardList();
        })
    },
    GetCardList: function () {
        $.ajax({
            url: CONFIG.BASEURL + "/news/listAll",
            type: "post",
            dataType: "json",
            ...
            success: function (data) {
                if (data.code == 2000) {
                    ...
                    _.map(Menu.Data.List, function (n, i) {
                        ...
                        _.map(n.newsItems, function (subn) {
                            subn.thumbLink = CONFIG.BASEURL + subn.thumbLink;
                        });
                        n.first = n.newsItems[0];
                        n.itemList = _.filter(n.newsItems, function (subn, subi) {
                            return subi != 0;
                        });
                        return n;
                    });
